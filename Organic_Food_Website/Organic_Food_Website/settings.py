"""
Django settings for Organic_Food_Website project.
...
SECRET_KEY = 'django-insecure-3x*w++$m0ot6bksuk67(^*w%(ha$#p78#s42#klufh8mguk_5h'
...
ROOT_URLCONF = 'Organic_Food_Website.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Home.context_proceesor.link_reverse',
                'cart_Checkout.context_processors.cart_view',
            ],
        },
    },
]

WSGI_APPLICATION = 'Organic_Food_Website.wsgi.application'
